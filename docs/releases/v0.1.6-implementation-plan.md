...
| --- | --- | --- |
| 0. Contract and fixtures | Planned | Approved documents, baseline, sanitized fixtures, dependency decision |
| 1. Registry and normalization | Planned | Fixture-only adapter tests and security boundary tests |
| 2. Migration and cache | Planned | Schema-005 migration, coverage, backup/export, future-schema tests |
| 3. Current refresh | Planned | Persistence, dirty-state, eligibility, partial-result tests |
| 4. Daily history | Planned | Cache, history selection, rebuild, analytics regression tests |
| 5. Product experience | Planned | IPC/binding, UI, locale, accessibility, capability checks |
| 6. Closeout | Planned | Full checks, isolated-data smoke, artifact/release evidence |
