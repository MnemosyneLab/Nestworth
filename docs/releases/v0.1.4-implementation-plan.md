...
**Status:** Planned. No phase is implemented. No phase is implemented merely because an earlier release contains a similarly named service, observation, or command.
...
| 1 | Analytics domain, signed values, and lot ledger | `Planned` |
| 2 | Migration 004, declarations, and unknown-basis identity | `Planned` |
| 3 | Cost basis, realized gain, and unrealized gain | `Planned` |
| 4 | Income, fees, and currency decomposition | `Planned` |
| 5 | Return engine | `Planned` |
| 6 | Net-worth attribution bridge | `Planned` |
| 7 | Analytics IPC and queries | `Planned` |
| 8 | Analytics route, lots, and basis declarations | `Planned` |
| 9 | Portfolio, Account, and Overview integration | `Planned` |
| 10 | Integrity, privacy, and compatibility closeout | `Planned` |
| 11 | Release closeout | `Planned` |
