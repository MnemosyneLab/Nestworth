...
**Status:** Phase 0 is implemented. Phases 1–11 are not implemented. No later phase is implemented merely because an earlier release contains a similarly named service, observation, or command.
