...
**Status:** Phases 0–4 implemented; 5–11 not. No later phase is implemented merely because an earlier release contains a similarly named service, observation, or command.
