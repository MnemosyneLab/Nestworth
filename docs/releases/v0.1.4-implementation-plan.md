...
**Status:** Phases 0–7 implemented; 8–11 not. No later phase is implemented merely because an earlier release contains a similarly named service, observation, or command.
