...
**Status:** Feature implementation is development-complete and this closeout records implemented truth. Phase 10 remains the named macOS release closeout. No phase is implemented merely because an earlier release contains a similarly named observation or command.
