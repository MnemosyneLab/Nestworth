...
**Status:** `Planned`. No phase is implemented merely because an earlier release contains a similarly named observation or command.
...
- Same-currency mismatch and cross-currency rate mismatch write nothing.
- Cross-currency transfer retains both native amounts and exact FxRate.
...
| 1 | Activity domain and time | `Planned` |
| 2 | Migration 003, repositories, and History Origin | `Planned` |
| 3 | Ledger core and current projections | `Planned` |
| 4 | Transfers, trades, debt principal, and corrections | `Planned` |
| 5 | Effective-dated state and historical valuation | `Planned` |
| 6 | Snapshot revisions, queries, and IPC | `Planned` |
| 7 | Activity and Account Timeline UI | `Planned` |
| 8 | Net-worth trend and snapshot experience | `Planned` |
| 9 | Integrity, privacy, and compatibility closeout | `Planned` |
| 10 | Release closeout | `Planned` |
