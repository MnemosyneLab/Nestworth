...
| [v0.1.4 Release Contract](releases/v0.1.4.md) | Planned analytics and performance scope, locked product decisions, acceptance scenarios, and compatibility promises |
| [v0.1.4 Technical Design](releases/v0.1.4-technical-design.md) | Planned lot ledger, cost basis, gain, currency decomposition, return, attribution, persistence, IPC, and UI contracts |
